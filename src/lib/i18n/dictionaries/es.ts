...
export const es = {
  ...
  header: {
    ...
    menuTitle: "Menú",
    menuCtaTableTitle: "Ver gastos en tabla",
    menuCtaTableBody: "Planilla por banco, gráficos y simulá escenarios",
    menuCtaTableBadge: "Nuevo",
  ...
  settings: {
    ...
    instructionsPlaceholder:
      "Ej.: Supermercados siempre ALIMENTACION. Spotify y Netflix → SUSCRIPCIONES. Si veo \"nafta\" o un peaje, categorizar como TRANSPORTE.",
  ...
  monthGrid: {
    viewTable: "Tabla",
    viewChrono: "Cronológico",
    modeTable: "Tabla",
    modeCharts: "Gráficos",
    modeSim: "Simular",
    title: "Gastos en tabla",
    subtitle:
      "Click = preguntar · Doble click = editar · Simular = qué pasa si…",
    filterAll: "Todos",
    filterRecurring: "Recurrentes",
    filterOneOff: "Puntuales",
    expandAll: "Expandir",
    ...
    kindOneOff: "Puntual",
    kpiTotal: "Total mes",
    kpiRecurring: "Recurrente",
    kpiOneOff: "Puntual",
    kpiBanks: "Bancos",
    kpiVsReal: (amount: string) => `−${amount} vs real`,
    kpiPctOfMonth: (pct: number) => `${pct}% del mes`,
    kpiActiveLines: (n: number) => `${n} activos`,
    tipAsk: "Clickeá cualquier número para preguntarme al toque.",
    tipSim: (amount: string) =>
      `Con la simulación te ahorrás ${amount} respecto al mes real.`,
    tipOneOffHeavy: (pct: number, amount: string) =>
      `Este mes el ${pct}% fue puntual (${amount}). El margen para mirar está ahí.`,
    tipFilterHint: "El filtro solo afecta la tabla.",
    wasAmount: (amount: string) => `era ${amount}`,
    totalVisible: "Total visible",
    lineCount: (n: number) => `${n} gasto${n === 1 ? "" : "s"}`,
    emptyMonth: "No hay gastos este mes.",
    editSaved: "Dato actualizado",
    editError: "No se pudo guardar.",
    chartByCategory: "Por categoría",
    chartByCategoryHint: "Dónde se concentra el mes",
    chartByBank: "Por banco",
    chartByBankHint: "Quién se lleva más plata",
    chartByKind: "Recurrente vs puntual",
    chartByKindHint: "Estructura del gasto",
    chartTop: "Top 8 gastos",
    chartTopHint: "Los más pesados del mes",
    chartEmpty: "No hay datos para graficar.",
    simSavedLabel: "Ahorro simulado",
    simSavedHint: "vs total real del mes",
    simTotalLabel: "Total simulado",
    simBaselineLabel: "Total real",
    simReset: "Resetear simulación",
    simNoDelivery: "Sin delivery",
    simIntro:
      "Desmarcá un gasto para sacarlo del mes, o bajá el % para deducir parte. No se guarda hasta que edites de verdad.",
    simOriginal: "Original",
    simCut: "Reducir %",
    simEffective: "Efectivo",
    simResetToast: "Simulación reseteada",
    simDeliveryToast: "Simulación: sin delivery",
    chatTitle: "Chat con Clara",
    chatClear: "Limpiar",
    chatEmptyTitle: "¿Sobre qué querés preguntar?",
    chatEmptyBody: "Clickeá un valor. Se abre un input flotante y la respuesta aparece acá.",
    chatNoContext: "Sin contexto",
    chatContext: (label: string) => `Contexto · ${label}`,
    floatAskingAbout: "Preguntando sobre",
    floatPlaceholder: "Preguntale a Clara sobre esto…",
    floatHintMuch: "¿Es mucho?",
    floatHintRemove: "¿Qué pasa si lo saco?",
    floatHintCategory: "Comparalo con la categoría",
    floatHintBank: "¿En qué se me va más?",
    floatHintSave: "¿Dónde ahorrar?",
    discovery: "Nueva vista tabla en desktop — probala desde el toggle de arriba.",
  },
